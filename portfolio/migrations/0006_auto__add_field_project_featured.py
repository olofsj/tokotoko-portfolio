...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portfolio_project', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.featured'
        db.delete_column('portfolio_project', 'featured')
